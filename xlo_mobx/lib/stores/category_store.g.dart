...
mixin _$CategoryStore on _CategoryStore, Store {
  Computed<List<Category>> _$allCategoryComputed;

  @override
  List<Category> get allCategory => (_$allCategoryComputed ??=
          Computed<List<Category>>(() => super.allCategory,
              name: '_CategoryStore.allCategory'))
      .value;
  ...
  void setCategory(List<Category> categories) {
    final _$actionInfo = _$_CategoryStoreActionController.startAction(
        name: '_CategoryStore.setCategory');
    try {
      return super.setCategory(categories);
    } finally {
